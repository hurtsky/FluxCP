    ...
    [
        ...
        'CharMapServers' => [
            [
                ...
                'WoeDisallow'   => [
                    ['module' => 'character', 'action' => 'online'],  // Disallow access to "Who's Online" page during WoE.
                    ['module' => 'character', 'action' => 'mapstats'], // Disallow access to "Map Statistics" page during WoE.
                ],
            ],
        ],
    ],
