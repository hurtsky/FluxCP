...
return [
    ...
    'ThemeName'					          => ['default', 'bootstrap'], // Names of the themes you would like list for use in the footer. Themes are in FLUX_ROOT/themes.
    ...
    'PayPalReceiverEmails'		=> [					// These are the receiver e-mail addresses who are allowed to receive payment.
    ...
    'BanPaymentStatuses'		      => [					// Payment statuses that will automatically ban the account owner if received.
    ...
    'ShopImageExtensions'		=> [					// These are the image extensions allowed for uploading in the item shop.
...
// Discord Webhooks
    ...
    'MenuItems'		=> [
        'MainMenuLabel'		=> [
            ...
            'DownloadsLabel'		=> ['module' => 'pages', 'action'=>'content&path=downloads'],
            'RulesLabel'			   => ['module' => 'pages', 'action'=>'content&path=rules'],
