...
<form action="<?php echo $this->url ?>" method="get" class="search-form">
	...
	<p>
		...
		<select name="base_level_op">
			<option value="eq"<?php if (($base_level_op = $params->get('base_level_op')) == 'eq') {
    echo ' selected="selected"';
} ?>>is equal to</option>
			<option value="gt"<?php if ($base_level_op == 'gt') {
    echo ' selected="selected"';
} ?>>is greater than</option>
			<option value="lt"<?php if ($base_level_op == 'lt') {
    echo ' selected="selected"';
} ?>>is less than</option>
		</select>
		...
		<select name="job_level_op">
			<option value="eq"<?php if (($job_level_op = $params->get('job_level_op')) == 'eq') {
    echo ' selected="selected"';
} ?>>is equal to</option>
			<option value="gt"<?php if ($job_level_op == 'gt') {
    echo ' selected="selected"';
} ?>>is greater than</option>
			<option value="lt"<?php if ($job_level_op == 'lt') {
    echo ' selected="selected"';
} ?>>is less than</option>
		</select>
		...
		<select name="zeny_op">
			<option value="eq"<?php if (($zeny_op = $params->get('zeny_op')) == 'eq') {
    echo ' selected="selected"';
} ?>>is equal to</option>
			<option value="gt"<?php if ($zeny_op == 'gt') {
    echo ' selected="selected"';
} ?>>is greater than</option>
			<option value="lt"<?php if ($zeny_op == 'lt') {
    echo ' selected="selected"';
} ?>>is less than</option>
		</select>
	...
	<p>	
		...
		<select name="online" id="online">
			<option value=""<?php if (!($online = $params->get('online'))) {
    echo ' selected="selected"';
} ?>>All</option>
			<option value="on"<?php if ($online == 'on') {
    echo ' selected="selected"';
} ?>>Online</option>
			<option value="off"<?php if ($online == 'off') {
    echo ' selected="selected"';
} ?>>Offline</option>
		</select>
		...
		...
		<select name="slot_op">
			<option value="eq"<?php if (($slot_op = $params->get('slot_op')) == 'eq') {
    echo ' selected="selected"';
} ?>>is equal to</option>
			<option value="gt"<?php if ($slot_op == 'gt') {
    echo ' selected="selected"';
} ?>>is greater than</option>
			<option value="lt"<?php if ($slot_op == 'lt') {
    echo ' selected="selected"';
} ?>>is less than</option>
		</select>
