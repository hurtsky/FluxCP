...
<form action="<?php echo $this->urlWithQs ?>" method="post" class="generic-form">
	...
	<table class="generic-form-table">
		<tr>
			...
			<td><input type="checkbox" name="hide_from_whos_online" id="hide_from_whos_online"<?php if ($hideFromWhosOnline) {
    echo ' checked="checked"';
		...
		<tr>
			...
			<td><input type="checkbox" name="hide_map_from_whos_online" id="hide_map_from_whos_online"<?php if ($hideMapFromWhosOnline) {
    echo ' checked="checked"';
} ?> /></td>
		...
		<tr>
			...
			<td><input type="checkbox" name="hide_from_zeny_ranking" id="hide_from_zeny_ranking"<?php if ($hideFromZenyRanking) {
    echo ' checked="checked"';
} ?> /></td>
