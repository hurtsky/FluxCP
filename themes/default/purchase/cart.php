		...
		<tr>
			...
			<td>
				...
				<p class="shop-item-action">
					...
					<?php endif ?>
					<a href="<?php echo $this->url('purchase', 'remove', ['num' => $num]) ?>">Remove from Cart</a> /
					<a href="<?php echo $this->url('purchase', 'add', ['id' => $item->shop_item_id, 'cart' => true]) ?>">Add Another to Cart</a>
				</p>
