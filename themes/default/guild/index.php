...
<form action="<?php echo $this->url ?>" method="get" class="search-form">
	...
	<p>
		...
		<select name="guild_level_op">
			<option value="eq"<?php if (($guild_level_op = $params->get('guild_level_op')) == 'eq') {
    echo ' selected="selected"';
} ?>>is equal to</option>
			<option value="gt"<?php if ($guild_level_op == 'gt') {
    echo ' selected="selected"';
} ?>>is greater than</option>
			<option value="lt"<?php if ($guild_level_op == 'lt') {
    echo ' selected="selected"';
} ?>>is less than</option>
		</select>
		...
		<select name="connect_member_op">
			<option value="eq"<?php if (($connect_member_op = $params->get('connect_member_op')) == 'eq') {
    echo ' selected="selected"';
} ?>>is equal to</option>
			<option value="gt"<?php if ($connect_member_op == 'gt') {
    echo ' selected="selected"';
} ?>>is greater than</option>
			<option value="lt"<?php if ($connect_member_op == 'lt') {
    echo ' selected="selected"';
} ?>>is less than</option>
		</select>
		...
		<select name="max_member_op">
			<option value="eq"<?php if (($max_member_op = $params->get('max_member_op')) == 'eq') {
    echo ' selected="selected"';
} ?>>is equal to</option>
			<option value="gt"<?php if ($max_member_op == 'gt') {
    echo ' selected="selected"';
} ?>>is greater than</option>
			<option value="lt"<?php if ($max_member_op == 'lt') {
    echo ' selected="selected"';
} ?>>is less than</option>
		</select>
	...
	<p>
		...
		<select name="average_lv_op">
			<option value="eq"<?php if (($average_lv_op = $params->get('average_lv_op')) == 'eq') {
    echo ' selected="selected"';
} ?>>is equal to</option>
			<option value="gt"<?php if ($average_lv_op == 'gt') {
    echo ' selected="selected"';
} ?>>is greater than</option>
			<option value="lt"<?php if ($average_lv_op == 'lt') {
    echo ' selected="selected"';
} ?>>is less than</option>
		</select>
