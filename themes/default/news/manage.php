	...
	<table class="horizontal-table" width="100%">  
		...
		<?php foreach ($news as $nrow):?>
			<tr>
				...
				<td>
					<a href="<?php echo $this->url('news', 'edit', ['id' => $nrow->id]); ?>">Edit</a> |
					<a href="<?php echo $this->url('news', 'delete', ['id' => $nrow->id]); ?>" onclick="return confirm('<?php echo htmlspecialchars(Flux::message('CMSConfirmDeleteLabel')) ?>');">Delete</a>
				</td>
			</tr>
		<?php endforeach; ?>
	</table>
