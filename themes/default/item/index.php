...
<form class="search-form" method="get">
	...
	<p>
		...
		<select name="type">
			<option value="-1"<?php if (($type = $params->get('type')) === '-1') {
    echo ' selected="selected"';
} ?>>
				Any
			</option>
			<?php foreach (Flux::config('ItemTypes')->toArray() as $typeId => $typeName): ?>
				<option value="<?php echo $typeId ?>"<?php if (($type = $params->get('type')) === strval($typeId)) {
    echo ' selected="selected"';
} ?>>
				...
				<?php if (array_key_exists($typeId, $itemTypes2)): ?>
					...
					<option value="<?php echo $typeId ?>-<?php echo $typeId2 ?>"<?php if (($type = $params->get('type')) === ($typeId.'-'.$typeId2)) {
    echo ' selected="selected"';
} ?>>
		...
		<select name="equip_loc">
			<option value="-1"<?php if (($equip_loc = $params->get('equip_loc')) === '-1') {
    echo ' selected="selected"';
} ?>>
				Any
			</option>
			<?php foreach (Flux::config('EquipLocationCombinations')->toArray() as $locId => $locName): ?>
				<option value="<?php echo $locId ?>"<?php if (($equip_loc = $params->get('equip_loc')) === strval($locId)) {
    echo ' selected="selected"';
} ?>>
	...
	<p>
		...
		<select name="npc_buy_op">
			<option value="eq"<?php if (($npc_buy_op = $params->get('npc_buy_op')) == 'eq') {
    echo ' selected="selected"';
} ?>>is equal to</option>
			<option value="gt"<?php if ($npc_buy_op == 'gt') {
    echo ' selected="selected"';
} ?>>is greater than</option>
			<option value="lt"<?php if ($npc_buy_op == 'lt') {
    echo ' selected="selected"';
} ?>>is less than</option>
		</select>
		...
		<select name="npc_sell_op">
			<option value="eq"<?php if (($npc_sell_op = $params->get('npc_sell_op')) == 'eq') {
    echo ' selected="selected"';
} ?>>is equal to</option>
			<option value="gt"<?php if ($npc_sell_op == 'gt') {
    echo ' selected="selected"';
} ?>>is greater than</option>
			<option value="lt"<?php if ($npc_sell_op == 'lt') {
    echo ' selected="selected"';
} ?>>is less than</option>
		</select>
		...
		<select name="weight_op">
			<option value="eq"<?php if (($weight_op = $params->get('weight_op')) == 'eq') {
    echo ' selected="selected"';
} ?>>is equal to</option>
			<option value="gt"<?php if ($weight_op == 'gt') {
    echo ' selected="selected"';
} ?>>is greater than</option>
			<option value="lt"<?php if ($weight_op == 'lt') {
    echo ' selected="selected"';
} ?>>is less than</option>
		</select>
	...
	<p>
		...
		<select name="range_op">
			<option value="eq"<?php if (($range_op = $params->get('range_op')) == 'eq') {
    echo ' selected="selected"';
} ?>>is equal to</option>
			<option value="gt"<?php if ($range_op == 'gt') {
    echo ' selected="selected"';
} ?>>is greater than</option>
			<option value="lt"<?php if ($range_op == 'lt') {
    echo ' selected="selected"';
} ?>>is less than</option>
		</select>
		...
		<select name="slots_op">
			<option value="eq"<?php if (($slots_op = $params->get('slots_op')) == 'eq') {
    echo ' selected="selected"';
} ?>>is equal to</option>
			<option value="gt"<?php if ($slots_op == 'gt') {
    echo ' selected="selected"';
} ?>>is greater than</option>
			<option value="lt"<?php if ($slots_op == 'lt') {
    echo ' selected="selected"';
} ?>>is less than</option>
		</select>
		...
		<select name="defense_op">
			<option value="eq"<?php if (($defense_op = $params->get('defense_op')) == 'eq') {
    echo ' selected="selected"';
} ?>>is equal to</option>
			<option value="gt"<?php if ($defense_op == 'gt') {
    echo ' selected="selected"';
} ?>>is greater than</option>
			<option value="lt"<?php if ($defense_op == 'lt') {
    echo ' selected="selected"';
} ?>>is less than</option>
		</select>
	...
	<p>
		...
		<select name="attack_op">
			<option value="eq"<?php if (($attack_op = $params->get('attack_op')) == 'eq') {
    echo ' selected="selected"';
} ?>>is equal to</option>
			<option value="gt"<?php if ($attack_op == 'gt') {
    echo ' selected="selected"';
} ?>>is greater than</option>
			<option value="lt"<?php if ($attack_op == 'lt') {
    echo ' selected="selected"';
} ?>>is less than</option>
		</select>
		...
		<select name="matk_op">
			<option value="eq"<?php if (($matk_op = $params->get('matk_op')) == 'eq') {
    echo ' selected="selected"';
} ?>>is equal to</option>
			<option value="gt"<?php if ($matk_op == 'gt') {
    echo ' selected="selected"';
} ?>>is greater than</option>
			<option value="lt"<?php if ($matk_op == 'lt') {
    echo ' selected="selected"';
} ?>>is less than</option>
		</select>
		...
		<select name="refineable" id="refineable">
			<option value=""<?php if (!($refineable = $params->get('refineable'))) {
    echo ' selected="selected"';
} ?>>All</option>
			<option value="yes"<?php if ($refineable == 'yes') {
    echo ' selected="selected"';
} ?>>Yes</option>
			<option value="no"<?php if ($refineable == 'no') {
    echo ' selected="selected"';
} ?>>No</option>
		</select>
		...
		...
		<select name="for_sale" id="for_sale">
			<option value=""<?php if (!($for_sale = $params->get('for_sale'))) {
    echo ' selected="selected"';
} ?>>All</option>
			<option value="yes"<?php if ($for_sale == 'yes') {
    echo ' selected="selected"';
} ?>>Yes</option>
			<option value="no"<?php if ($for_sale == 'no') {
    echo ' selected="selected"';
} ?>>No</option>
		</select>
		...
