...
class Flux_Config
{
     ...
     * @var array
     */
    private $defaultSetOptions = ['overwrite' => true, 'force' => true];
    ...
    public function get($key, $configObjectIfArray = true)
    {
        ...
        if (array_key_exists($currentKey, $base)) {
            ...
            } elseif ($value instanceof self && !$configObjectIfArray) {
    ...
    public function merge(self $config, $recursive = true)
    {
