...
$customDataArray = ['server_name' => $session->loginAthenaGroup->serverName, 'account_id' => $session->account->account_id];
...
<input type="hidden" name="notify_url" value="<?php echo $this->url('donate', 'notify', ['_host' => true]) ?>" />
<input type="hidden" name="return" value="<?php echo $this->url('main', 'index', ['_host' => true]) ?>" />
